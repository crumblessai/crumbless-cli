...
#
# Usage:
#   curl -sSL https://raw.githubusercontent.com/crumblessai/crumbless-cli/main/scripts/install.sh | bash              # Install
#   curl -sSL https://raw.githubusercontent.com/crumblessai/crumbless-cli/main/scripts/install.sh | bash -s -- --update  # Update
#
# Options:
...
REPO="crumblessai/crumbless-cli"  # GitHub org/repo
...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    -h|--help)
      echo "Usage: curl -sSL https://raw.githubusercontent.com/crumblessai/crumbless-cli/main/scripts/install.sh | bash"
      echo ""
      echo "Options:"
