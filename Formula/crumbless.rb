...
class Crumbless < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/anomaliaso/anomalia/releases/download/v#{version}/crumbless-macos-arm64.tar.gz"
      sha256 "REPLACE_SHA256_MACOS_ARM64"
    end
    on_intel do
      url "https://github.com/anomaliaso/anomalia/releases/download/v#{version}/crumbless-macos-x64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/anomaliaso/anomalia/releases/download/v#{version}/crumbless-linux-arm64.tar.gz"
      sha256 "REPLACE_SHA256_LINUX_ARM64"
    end
    on_intel do
      url "https://github.com/anomaliaso/anomalia/releases/download/v#{version}/crumbless-linux-x64.tar.gz"
